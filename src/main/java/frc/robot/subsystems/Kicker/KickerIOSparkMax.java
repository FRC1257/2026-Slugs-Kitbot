...
public class KickerIOSparkMax implements KickerIO{
    ...
    public KickerIOSparkMax(){
        feedforward = new SimpleMotorFeedforward(KickerConstants.KICKER_KS, KickerConstants.KICKER_KV, KickerConstants.KICKER_KA);
    ...
    public void updateInputs(KickerIOInputs inputs){
        inputs.kickerLoaded = kickerMotor.getLastError() == REVLibError.kOk;
        ...
        AngularVelocity last_AngV= inputs.kickerAngularVelocity;
    }
    ...
    public void setVelocity(AngularVelocity velocity) {
        ...
        .getClosedLoopController()
                ...
                //feedforward.calculate(inputs.kickerVoltage, inputs.kickerVoltage,(inputs.kickerAngularVelocity-last_AngV)/0.002));
    ...
    public void setFF(double kS,double kV, double kA){
        //Eliminates the dead zone that pay lead to a ball being stuck because of friction, gives the perfect amount of force
        feedforward = new SimpleMotorFeedforward(kS, kV, kA);
          
        //note feedfrward was implemented weird idk if it was supposed to be like that but it gave errors so i changed it :'(
        //tried to keep the vibe tho?
    }        
}
